...
class RCCbase(object):
	def __init__(self,pdb,chain,autochain,chain_segments,tmpdir=""):
		...
		os.system('python make_RIG.py ' + pdb + ' ' + chain  + ' 5.0 >' + tmpdir + 'tmpgraph');
		os.system('rm -rf output*')
		fin = open(tmpdir +'tmpgraph',"r")
...
class RCC(RCCbase):
	def __init__(self,pdb,chain,autochain=False,chain_segments=[],tmpdir=""):
		super(RCC,self).__init__(pdb,chain,autochain,chain_segments,tmpdir)
