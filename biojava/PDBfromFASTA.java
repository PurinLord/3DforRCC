...
public class PDBfromFASTA {
	...
	private int defaultASP = 4;
	private int defaultGLU = 24;
	private int defaultILE = 2;
	private int defaultPHE = 5;
	private int defaultTRP = 9;
	private int defaultALA = 1;
	//private int defaultCYH = 3;
	private int defaultGLY = 1;
	private int defaultLEU = 8;
	private int defaultPRO = 1;
	private int defaultTYR = 5;
	private int defaultARG = 65;
	private int defaultCYS = 3;
	//private int defaultHID = 14;
	private int defaultLYS = 69;
	private int defaultSER = 3;
	private int defaultVAL = 1;
	private int defaultASN = 7;
	private int defaultGLN = 46;
	private int defaultHIS = 17;
	private int defaultMET = 24;
	private int defaultTHR = 3;
	...
	public static void main(String[] args){
		try{
			...
			writePDB("datos/out.pdb", pff.shapeProtein(pdb));
